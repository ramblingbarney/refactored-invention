...
cors = CORS(
    app, resources={r"/*": {"origins": "guess-the-next-line.herokuapp.com"}})

# list of video ids that have lyrics provided by musixmatch
pre_canned_videoId = [
    'YQHsXMglC9A', '0-EF60neguk', 'MN3x-kAbgFU', 'YR5ApYxkU-U', 'n4RjJKxsamQ',
    'raNGeq3_DtM', 'TvnYmWpD_T8', 'x5GuBa4Bbnw', '4YR_Mft7yIM', 'JJAXwAaA2w',
    'u1xrNaTO1bI', 'jhdFe3evXpk', 'YQHsXMglC9A']
...
if __name__ == '__main__':
    app.run(host=os.environ.get('IP'), port=os.environ['PORT'], debug=False)
